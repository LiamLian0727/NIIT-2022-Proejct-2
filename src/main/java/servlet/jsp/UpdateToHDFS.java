...
import static utils.DataFromTxt.dataFromTxtToHive;
...
public class UpdateToHDFS extends HttpServlet {
    ...
    private static final String URL = "http://localhost:8080/Group2/analyze/index.jsp";
                ...
                if (formItems != null && formItems.size() > 0) {
                    for (FileItem item : formItems) {
                        if (!item.isFormField()) {
                            ...
                            if (b) {
                                dataFromTxtToHive("hdfs://niit:9000" + DfsUtil.getPATH() + fileName);
                            }
                        }
                    }
                }
