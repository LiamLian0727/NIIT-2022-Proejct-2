...
<div>
    <div class="divs" id="left" style="width:30%;float:left;">
        <form class="forms" action="../Echart2" method="post">
            <h1 class="h">JSP2</h1><br>
            <h2 class="h">Rate:</h2><input class="inputs" type="number" name="rate">
            <h2 class="h">Len:</h2><input class="inputs" type="number" name="len">
            <h2 class="h">Limit:</h2><input class="inputs" type="number" name="limit"/><br>
